...
/**
 * Event handler for when the "Update dependencies to minor" toolbar icon is clicked.
 */
export class OnUpdateDependenciesMinorClick extends OnUpdateDependenciesClick {

  /**
   * Initializes a new instance of the OnUpdateDependenciesMinorClick class.
