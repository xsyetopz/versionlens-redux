...
/**
 * Event handler for when the "Update dependencies to major" toolbar icon is clicked.
 */
export class OnUpdateDependenciesMajorClick extends OnUpdateDependenciesClick {

  /**
   * Initializes a new instance of the OnUpdateDependenciesMajorClick class.
