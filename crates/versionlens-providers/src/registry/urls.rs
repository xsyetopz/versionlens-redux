...
use package::{
    ...
    dub_registry_url, dub_registry_url_with_base, github_registry_url,
    github_registry_url_with_base, hackage_registry_url, hackage_registry_url_with_base,
    haxelib_registry_url, haxelib_registry_url_with_base, helm_registry_url,
    helm_registry_url_with_base, hex_registry_url, hex_registry_url_with_base, julia_registry_url,
    julia_registry_url_with_base, luarocks_registry_url, luarocks_registry_url_with_base,
    nim_registry_url, nim_registry_url_with_base, nix_registry_url, nix_registry_url_with_base,
    npm_registry_url, npm_registry_url_with_base, opam_registry_url, opam_registry_url_with_base,
    ...
    swift_registry_url, swift_registry_url_with_base, terraform_registry_url,
    terraform_registry_url_with_base, unity_registry_url, unity_registry_url_with_base,
    vcpkg_registry_url, vcpkg_registry_url_with_base, zig_registry_url, zig_registry_url_with_base,
};
