...
pub(crate) fn parse_meson_wrap(text: &str) -> CppDependencies {
    ...
    let Some(repo) = github::repository_from_url(
        url.value,
        &[
            "https://github.com/",
            "http://github.com/",
...
fn cmake_call_dependencies(text: &str, function: &str, call: Field<'_>) -> CppDependencies {
    ...
    let repo = github::repository_from_url(
        url.value,
        &[
            "https://github.com/",
            "http://github.com/",
    ...
    .or_else(|| github::repository_from_path(url.value));
...
fn cpp_dependency(text: &str, source: CppDependencySource<'_>) -> Dependency {
    Dependency {
        ...
        hosted_url: source.repo.and_then(|repo| github::tags_url(repo)),
